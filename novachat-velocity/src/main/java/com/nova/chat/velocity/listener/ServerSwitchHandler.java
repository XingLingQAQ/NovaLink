...
public class ServerSwitchHandler {
     ...
     */
    private void handleChannelTransition(Player player, PlayerChannelState state, 
     ...
     */
    private void joinDefaultChannel(Player player, PlayerChannelState state, String server) {
