...
/**
 * Quilt-specific command context that provides proper message sending
 * Compatible with Fabric API through Quilted Fabric API
 */
public class QuiltCommandContext extends CommandContext {
    private final CommandSourceStack source;
    
    public QuiltCommandContext(UUID playerId, String playerName, Platform platform, boolean isAdmin, CommandSourceStack source) {
