...
/**
 * Configuration for a server-scoped channel.
 * 
 * Requirements: 5.1, 5.5, 20.4, 20.5 - Server channel configuration with template support
 */
public class ServerChannelConfig {
    ...
    public boolean equals(Object o) {
        ...
        ServerChannelConfig that = (ServerChannelConfig) o;
        return Objects.equals(useTemplate, that.useTemplate) &&
