 ...
 *
 * @deprecated Superseded by the shared {@link com.nova.chat.client.state.PlayerChannelState}.
 *     Kept only as a compilation shim for any references not yet migrated; the
 *     command path now operates on the shared state type via
