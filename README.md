...
|---------|----------|------------------|--------|
| NovaLink-Java | Java 17+ | v1 | ✅ Stable |
| NovaLink-Go | Go 1.21+ | v1 | ✅ Stable |

### Java Edition Clients

| Platform | Language | Minecraft Version | Protocol | Status |
|----------|----------|-------------------|----------|--------|
| Bukkit/Spigot/Paper | Java 8+ | 1.8+ | v1 | ✅ Stable |
| Velocity | Java 17+ | Proxy | v1 | ✅ Stable |
| BungeeCord | Java 8+ | Proxy | v1 | ✅ Stable |
| Fabric | Java 17+ | 1.20.x+ | v1 | ✅ Stable |
| NeoForge | Java 17+ | 1.20.2+ | v1 | ✅ Stable |
| Quilt | Java 17+ | 1.20.x+ | v1 | ✅ Stable |
| Forge | Java 17+ | 1.20.x | v1 | ✅ Stable |

### Bedrock Edition Clients

| Platform | Language | Minecraft Version | Protocol | Status |
|----------|----------|-------------------|----------|--------|
| Nukkit | Java 8+ | Bedrock | v1 | ✅ Stable |
| PowerNukkitX | Java 17+ | Bedrock 1.20+ | v1 | ✅ Stable |
| LeviLamina (BDS) | C++ | Bedrock | v1 | ✅ Stable |
| PocketMine-MP | PHP 8.1+ | Bedrock | v1 | ✅ Stable |
| Endstone | Python 3.10+ | Bedrock | v1 | ✅ Stable |
...
- Java 17+ (for NovaLink backend and modern plugins)
- Java 8+ (for legacy Minecraft plugins)
- Go 1.21+ (for NovaLink-Go backend)
...
| 后端 | 语言 | 协议版本 | 状态 |
|------|------|----------|------|
| NovaLink-Java | Java 17+ | v1 | ✅ 稳定 |
| NovaLink-Go | Go 1.21+ | v1 | ✅ 稳定 |

### Java 版客户端

| 平台 | 语言 | Minecraft 版本 | 协议 | 状态 |
|------|------|----------------|------|------|
| Bukkit/Spigot/Paper | Java 8+ | 1.8+ | v1 | ✅ 稳定 |
| Velocity | Java 17+ | 代理端 | v1 | ✅ 稳定 |
| BungeeCord | Java 8+ | 代理端 | v1 | ✅ 稳定 |
| Fabric | Java 17+ | 1.20.x+ | v1 | ✅ 稳定 |
| NeoForge | Java 17+ | 1.20.2+ | v1 | ✅ 稳定 |
| Quilt | Java 17+ | 1.20.x+ | v1 | ✅ 稳定 |
| Forge | Java 17+ | 1.20.x | v1 | ✅ 稳定 |

### 基岩版客户端

| 平台 | 语言 | Minecraft 版本 | 协议 | 状态 |
|------|------|----------------|------|------|
| Nukkit | Java 8+ | 基岩版 | v1 | ✅ 稳定 |
| PowerNukkitX | Java 17+ | 基岩版 1.20+ | v1 | ✅ 稳定 |
| LeviLamina (BDS) | C++ | 基岩版 | v1 | ✅ 稳定 |
| PocketMine-MP | PHP 8.1+ | 基岩版 | v1 | ✅ 稳定 |
| Endstone | Python 3.10+ | 基岩版 | v1 | ✅ 稳定 |
...
- Java 17+（NovaLink 后端和现代插件）
- Java 8+（旧版 Minecraft 插件）
- Go 1.21+（NovaLink-Go 后端）
