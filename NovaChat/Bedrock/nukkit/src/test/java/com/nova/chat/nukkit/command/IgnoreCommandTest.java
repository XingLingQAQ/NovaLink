...
/**
 * Unit tests for the Nukkit {@code /nc ignore} / {@code /nc unignore} command
 * shells: argument forwarding to the shared IgnoreCommandService and the
 * localized receipts sent back to the player (mirrors the Bukkit
 * IgnoreCommandTest).
 */
@DisplayName("Nukkit Ignore/Unignore commands")
...
class IgnoreCommandTest {
    ...
    private String lastMessage() {
        ...
        verify(messageHelper, atLeastOnce()).sendRawMessage(eq(player), captor.capture());
