...
public class VersionDetector {
    ...
    public VersionRange getVersionRange() {
        // Calendar-line versions (26.x+) use modern Component/chat APIs
        if (majorVersion >= 26 || isAtLeast(1, 20)) {
     ...
     * @return true if version is supported (1.14+ or 26.x calendar line)
     */
    public boolean isSupported() {
        return majorVersion >= 26 || isAtLeast(1, 14);
    }
    ...
    public String getVersionRangeDescription() {
        ...
        return switch (range) {
            ...
            case MODERN_1_20_PLUS -> "1.20.x - 1.21.x / 26.x";
