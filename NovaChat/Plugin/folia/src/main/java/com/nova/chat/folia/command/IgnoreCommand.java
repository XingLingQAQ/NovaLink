 ...
 * sends the returned lines. No backend packet. The shared service is
 * thread-safe, so calling it from any Folia region thread is fine.
 */
public class IgnoreCommand extends AbstractSubCommand {

    public IgnoreCommand(NovaChatFolia plugin) {
        super(plugin);
    }
