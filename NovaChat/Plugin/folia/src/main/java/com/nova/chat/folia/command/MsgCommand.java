 ...
 * sends the returned lines (thread-safe from any Folia region thread). The
 * success confirmation is rendered from the backend echo (see
 * {@code AsyncChatInterceptor#handlePrivateMessage}).
 */
public class MsgCommand extends AbstractSubCommand {

    public MsgCommand(NovaChatFolia plugin) {
        super(plugin);
    }
