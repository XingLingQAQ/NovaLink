 ...
 * both sent and received private messages; thread-safe across Folia region
 * threads); validation and receipt copy live in
 * {@link PrivateMessageCommandService}.
 */
public class ReplyCommand extends AbstractSubCommand {

    public ReplyCommand(NovaChatFolia plugin) {
        super(plugin);
    }
