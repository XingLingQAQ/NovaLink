...
public class NovaLinkMain {
    ...
    public static void main(String[] args) {
        ...
        registerPacketHandlers(networkHandler, configManager, authManager, channelManager, messageRouter, adminActionHandler, channelActionHandler);
        ...
        try {
            ...
            safeShutdown(webSocketGateway, tcpServer, networkHandler, databaseProvider, configManager, playerStateManager, webhookManager);
            return;
        }
    ...
    private static void registerPacketHandlers(ServerNetworkHandler networkHandler,
        ...
        // Chat message handler (enforce boundary isolation)
