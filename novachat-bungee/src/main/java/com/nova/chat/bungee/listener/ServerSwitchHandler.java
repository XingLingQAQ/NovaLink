...
import com.nova.chat.bungee.chat.PlayerChatState;
...
public class ServerSwitchHandler implements Listener {
     ...
     */
    private void handleChannelTransition(ProxiedPlayer player, PlayerChatState state, 
     ...
     */
    private void joinDefaultChannel(ProxiedPlayer player, PlayerChatState state, String server) {
