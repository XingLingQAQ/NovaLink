...
public class DebugCommand extends AbstractSubCommand {
    ...
    public DebugCommand(NovaChatMultiPaper plugin) {
        super(plugin);
    }
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (newState) {
            ...
            messageHelper.sendRaw(sender, "&7MultiPaper: &e" + plugin.getMultiPaperAdapter().isMultiPaper());
            messageHelper.sendRaw(sender, "&7实例 ID: &e" + plugin.getMultiPaperAdapter().getInstanceId());
