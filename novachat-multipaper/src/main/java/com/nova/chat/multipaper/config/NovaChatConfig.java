package com.nova.chat.multipaper.config;
...
/**
 * Configuration wrapper for NovaChat MultiPaper plugin.
...
public class NovaChatConfig {
    ...
    // MultiPaper specific settings
    private final boolean multiPaperSyncEnabled;
    private final String multiPaperInstanceId;
    ...
    public NovaChatConfig(FileConfiguration config) {
        ...
        // MultiPaper settings
        this.multiPaperSyncEnabled = config.getBoolean("multipaper.sync-enabled", true);
        this.multiPaperInstanceId = config.getString("multipaper.instance-id", "");
    ...
    public boolean isMultiPaperSyncEnabled() {
        return multiPaperSyncEnabled;
    }

    public String getMultiPaperInstanceId() {
        return multiPaperInstanceId;
    }
